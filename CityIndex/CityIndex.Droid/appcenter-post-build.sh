...
if [ "$APPCENTER_XAMARIN_CONFIGURATION" == "Debug" ];then
    ...
    appcenter test run uitest --app "natalya.zhenchak-gmail.com/Xamarin.Android" --devices "f669a62b" --app-path $APKFile --test-series "master" --locale "en_US" --build-dir $UITestBuildDir --uitest-tools-dir $TestCloudExeDirectory
